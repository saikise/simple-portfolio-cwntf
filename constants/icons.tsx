...
export const BOOK_NUGGETS_ICON = (
  <svg
    className="h-[15px] w-[15px] text-gray-800 dark:text-white"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
// SearchButtonGroup
export const SEARCH_BUTTON_GROUP_CODE_CRAFTS_ICON = (
  <svg
...
export const SEARCH_BUTTON_GROUP_BOOK_NUGGETS_ICON = (
  <svg
    className="mr-2 h-3 w-3"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const SEARCH_BUTTON_GROUP_THOUGHTS_ICON = (
  <svg
    className="mr-2 h-3 w-3"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
